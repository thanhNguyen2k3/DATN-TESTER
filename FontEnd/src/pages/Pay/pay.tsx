    ...
    return (
        ...
        <div className="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16">
            <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700">
                ...
                <div className="mb-10">
                    <h1 className="text-center font-bold text-xl uppercase">THÔNG TIN THANH TOÁN</h1>
                </div>
                ...
                <div className="mb-3">
                    <label className="font-bold text-sm mb-2 ml-1">Tên chủ thẻ</label>
                    <div>
                ...
                <div className="mb-3">
                    <label className="font-bold text-sm mb-2 ml-1">Số thẻ</label>
                    <div>
                ...
                <div className="mb-10">
                    <label className="font-bold text-sm mb-2 ml-1">Mã bảo mật</label>
                    <div>
                ...
                <div>
                    <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"><i className="mdi mdi-lock-outline mr-1"></i> THANH TOÁN</button>
                </div>
            </div>
        </div>
    )
